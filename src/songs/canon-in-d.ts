...
// D-A-B-F#-G-D-G-A adapted to our keys: D-A-B-F-G-D-G-A
// Dense note patterns with held notes make this the hardest song
const melody: [number, PianoKey, number][] = [
  // Phrase 1: D major chord progression melody - eighth note runs
  [0, 'D4', 1],
  [1, 'F4', 1],
  [2, 'A4', 1],
  [3, 'G4', 1],
