    ...
    <div className="fixed inset-0 flex items-center justify-center bg-black/70 backdrop-blur-sm z-50">
      <div className="text-center space-y-8">
        ...
        <div className="space-y-3">
          <button
            onClick={onResume}
            className="block w-48 mx-auto py-3 px-6 rounded-xl bg-gradient-to-r from-pink-500 to-purple-500 text-white font-bold text-lg hover:scale-105 active:scale-95 transition-transform"
          >
            Resume
          </button>
          <button
